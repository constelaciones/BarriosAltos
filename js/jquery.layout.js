 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	slideTrigger_close:		"click"	        // click, mouseout  //***************************//
...
//		,	fxSettings_close:		{ easing: "easeOutQuint" }
	...
	,	north: {
		...
		,	size:				45		//,	resizerCursor:	"n-resize" ***************** cambio height
	...
	,	east: {
		...
		//,	resizerCursor:			"e-resize"
                ...
                ,	spacing_open:			21			// space between pane and adjacent panes - when pane is 'open'
		,	spacing_closed:			21		
                ,	togglerLength_closed:	        80			// make toggler 'square' - 21x21
                ,	togglerLength_open:	        80		        
                ,	togglerAlign_closed:	        "top"		        // align to top of resizer
		,	togglerAlign_open:		"top" 			// NONE - using custom togglers INSIDE east-pane
		,	togglerTip_open:		"Cerrar panel"
		,	togglerTip_closed:		"Abrir panel"
                //,	togglerContent_open:	        "CERRAR"
                //,	togglerContent_closed:	        "ABRIR"
...
//                            }
	...
	,	west: {
		...
		//,	resizerCursor:			"w-resize"
                ...
                ,	fxName:			        "slide"
                ,       fxSpeed:                        "fast"
                //,	fxSettings:			{ easing: "easeOutBounce", duration: 500 } // nullify default easing
		}
